use utf8;
package Comserv::Model::Schema::ShantaForager::Result::EncyReferenceTb;
...
Comserv::Model::Schema::ShantaForager::Result::EncyReferenceTb
...
=head1 TABLE: C<ency_reference_tb>

=cut

__PACKAGE__->table("ency_reference_tb");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PPE7IdC9xj5G/voJpr4ZWA
