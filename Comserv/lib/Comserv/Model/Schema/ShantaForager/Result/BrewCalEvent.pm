use utf8;
package Comserv::Model::Schema::ShantaForager::Result::BrewCalEvent;
...
Comserv::Model::Schema::ShantaForager::Result::BrewCalEvent
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Y/UGbaM65nnapkerPS924g
