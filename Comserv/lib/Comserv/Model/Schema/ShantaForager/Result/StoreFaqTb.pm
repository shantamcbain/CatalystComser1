use utf8;
package Comserv::Model::Schema::ShantaForager::Result::StoreFaqTb;
...
Comserv::Model::Schema::ShantaForager::Result::StoreFaqTb
...
=head1 TABLE: C<store_faq_tb>

=cut

__PACKAGE__->table("store_faq_tb");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hpZIcFYitnSH79m8aHPX0w
