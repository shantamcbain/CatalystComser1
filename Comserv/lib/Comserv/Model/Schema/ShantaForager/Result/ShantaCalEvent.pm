use utf8;
package Comserv::Model::Schema::ShantaForager::Result::ShantaCalEvent;
...
Comserv::Model::Schema::ShantaForager::Result::ShantaCalEvent
...
=head1 TABLE: C<shanta_cal_event>

=cut

__PACKAGE__->table("shanta_cal_event");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VJfdRncV6eLRB4M1JSmsew
